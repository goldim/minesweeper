  ...
  qx.Bootstrap.define("qx.Mixin", {
    statics: {
      ...
      */
      ...
      __allowedKeys__P_9_1: qx.core.Environment.select("qx.debug", {
        "true": {
          include: "object",
          // Mixin | Mixin[]
          statics: "object",
       ...
       */
      __validateConfig__P_9_0: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          // Validate keys
          var allowed = this.__allowedKeys__P_9_1;
...
//# sourceMappingURL=Mixin.js.map?dt=1673131550571